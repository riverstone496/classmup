...
def train(epoch, prefix = '', train_iterations=-1, linear_training = False):
...
if __name__=='__main__':
    ...
    if args.save_ckpt:
        file_name = str(args.model) + '_' + str(args.dataset)  + '_wid_' + str(args.width) + '_ep_' + str(args.epochs) + '_param_' + str(args.parametrization) + '_tsize_' + str(args.train_size) + '_lr_' + str(args.lr) + '_loss_' + str(args.loss_type) + '_act_' + str(args.activation) + '.pt'
